...
public class Google1Test extends TestBase {
    @Autowired
    ...
    void visitGoogleAgain() throws Exception {
        ...
        littlePageObject.justTesting("https://www.aftonbladet.se/");

        if(!driver.getCurrentUrl().equalsIgnoreCase("https://www.aftonbladet.se/")) {
            System.out.println("hej hej");
            throw new Exception("faaail");
        }
    }
